...
<div class="flex flex-col gap-4">
	...
	<p>
		...
		id you do encounter any errors.
	</p>
	<div class="flex flex-col gap-4">
		<form
			class="flex flex-col card p-4 gap-4 justify-center"
			style="position: relative; height: 73rem"
			action="?/updateApp"
			method="post"
		>
			...
			<div class="flex flex-col p-4 gap-4 justify-center" style="transform: translateY(15rem)">
				...
				<label for="supportServer" class="label">
					...
					<input
						...
						type="text"
						name="supportServer"
						bind:value={$form.supportServer}
						{...$constraints.supportServer}
						placeholder="Enter support server link..."
					/>
				...
				<label for="vanityCode" class="label">
					...
					<input
						...
						type="text"
						name="vanityCode"
						bind:value={$form.vanityCode}
						{...$constraints.vanityCode}
						placeholder="cardboard.ink/a/code (leave blank for random)"
					/>
				...
				<button class="btn variant-filled" type="submit"> Update App </button>
			</div>
		</form>
