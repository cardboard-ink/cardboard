...
<div class="flex flex-col gap-4">
    ...
    <h6 class="h6">Note:</h6>
    <p>Carboard currently only supports up to 512KB/S of request body size per app update, this should not harm much functionality but please use compressed images and try splitting the updates id you do encounter any errors.</p>
    <div class="flex flex-col gap-4">
